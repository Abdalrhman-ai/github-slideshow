...
with open("intents.json") as file: #and ("Ass.json") 
    data = json.load(file)
...
def chat():
    ...
    while True:
        ...
        if results[results_index] > 0.8:
        ...
        elif inp=="What is the date today":
            ...
            A=wikipedia.summary(inp)
            print(A)
            speaker.Speak(A)

        #if inp=="" and t==50:
            #print("whare are you")
            #speaker.Speak("whare are you")
